function [eout,thresh,gv_45,gh_135] = GEdge(varargin)
...
if ~isa(varargin{1},'gpuArray')
    ...
    switch nargout
        ...
        case 2
            [eout,thresh] = CEdge(varargin{:});
            
        case 3
            [eout,thresh,gv_45] = CEdge(varargin{:});
            
        case 4
            [eout,thresh,gv_45,gh_135] = CEdge(varargin{:});
...
if any(strcmp(method, {'log','zerocross'}))
    ...
    op = op - sum(op,"all")/numel(op); % make the op to sum to zero
